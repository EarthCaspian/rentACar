...
public class MailService {
    ...
    public void sendContactPageEmail(ContactMailRequest request) throws MessagingException {
        String to = username;
        String subject = "Contact Us Mail";
        String mailContent = generateContactPageMailContent(request);
    ...
    private String generateContactPageMailContent(ContactMailRequest request) {
        return "<!DOCTYPE html>\n" +
                "<html lang=\"tr\">\n" +
                "<head>\n" +
                "    <meta charset=\"UTF-8\">\n" +
    ...
    public void sendJoinUsEmail(JoinUsMailRequest request) throws MessagingException {
        String to = username;
        String subject = "Join Us Mail";
        String mailContent = generateJoinUsMailContent(request);
    ...
    private String generateJoinUsMailContent(JoinUsMailRequest request) {
        return "<!DOCTYPE html>\n" +
                ...
                "    <meta charset=\"UTF-8\">\n" +
                "    <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">\n" +
                "    <title>Join Us Form Submission</title>\n" +
                "</head>\n" +
                "<body>\n" +
